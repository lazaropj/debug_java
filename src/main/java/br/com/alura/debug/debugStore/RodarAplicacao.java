...
public class RodarAplicacao {
	...
	public static void main(String[] args) {
		...
		List<Produto> produtos = criarProdutos(categoria);
	...
	private static List<Produto> criarProdutos(Categoria categoria) {
		...
		Produto mouse = new Produto("Mouse sem fio Microsoft",new BigDecimal(("120.00")), categoria);
		produtos.add(mouse);
		Produto teclado = new Produto("Teclado de Gamer Alien", new BigDecimal("350.00"), categoria);
		produtos.add(teclado);
		Produto monitor = new Produto("Monitor Lg 17 Widescreen", new BigDecimal("250.00"), categoria);
		produtos.add(monitor);
		Produto processador = new Produto("Processador Intel Core I7", new BigDecimal("1500.00"), categoria);
		produtos.add(processador);
		Produto cadeira = new Produto("Cadeira Racing Gamer", new BigDecimal("759.00"), categoria);
